...
This module is integrated with L<Callback::Frame>. In order to handle exceptions in a meaningful way, you will need to use this module. FIXME: Add examples and synopsis entry demonstrating this.
